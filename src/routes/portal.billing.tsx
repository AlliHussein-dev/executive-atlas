  ...
  return (
    <PortalShell>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 mb-10">
        <div className="bg-ivory border border-navy/10 p-6 sm:p-8">
          <p className="text-[10px] uppercase tracking-[0.25em] text-slate font-semibold mb-3">
            Outstanding
          </p>
        ...
        <div className="bg-ivory border border-navy/10 p-6 sm:p-8">
          ...
          <p className="font-display text-3xl sm:text-4xl text-navy">AED 80,150</p>
          <p className="text-slate text-xs mt-2">Across 4 invoices</p>
        </div>
        <div className="bg-navy text-sand p-6 sm:p-8 flex flex-col justify-between sm:col-span-2 lg:col-span-1">
          ...
          >
            ...
            <div className="md:hidden">
              <div className="flex items-baseline justify-between gap-3">
                <span className="font-display text-base text-navy">{inv.id}</span>
                <span className="font-display text-lg text-navy">
                  {inv.amount.replace("AED ", "AED ")}
                </span>
              </div>
              <p className="text-slate text-sm mt-2">{inv.description}</p>
              <div className="flex items-center justify-between mt-3 gap-3">
                <span className="text-[10px] uppercase tracking-[0.2em] text-slate font-semibold">
                  {inv.date}
                </span>
                <span
      ...
      <p className="text-[10px] uppercase tracking-[0.25em] text-slate font-semibold mt-8 text-center">
