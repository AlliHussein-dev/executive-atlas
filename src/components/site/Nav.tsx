  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-10 h-20 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-2 text-[11px] uppercase tracking-[0.2em] font-medium text-navy">
          {links.map((l) => (
            <Link
              key={l.to}
              to={l.to}
          ...
          <Link
            to="/portal"
            className="ml-4 px-5 py-2.5 border border-navy/30 hover:border-navy hover:bg-navy hover:text-sand transition-colors"
          >
            Client Portal
          </Link>
        </div>
